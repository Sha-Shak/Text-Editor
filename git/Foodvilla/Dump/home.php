...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        // echo "id: " . $row["productId"]. " - Name: " . $row["productname"]. " ". $row["productcategory"]. $row["size"]. "<br>";

        echo '<a href="singleitem.php?id='.$row["productId"].'" class="btn btn-success" style="margin:5px;">'.$row["productname"].'</a>';
    }
